...
4. Nice-to-have cleanup, opportunistic refactors, and adjacent improvements are out of scope unless explicitly approved.
5. If evidence is incomplete, choose the smallest safe interpretation and mark any unresolved expansion as `Ask User`.
