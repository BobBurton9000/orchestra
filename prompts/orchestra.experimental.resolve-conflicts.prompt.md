...
1. **Load branch and pull request context**:
	...
	3. Read `ai/orchestra/documents/<branch-name>/story.md`, `ai/orchestra/documents/<branch-name>/plan.md`, and `ai/orchestra/documents/<branch-name>/execution-report.md` when present so conflict decisions are grounded in the intended branch behaviour.
