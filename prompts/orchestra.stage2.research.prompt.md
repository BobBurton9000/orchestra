...
2. **Load the template**: Read [research.template](orchestra.templates/research.template.md) to determine what information you need to acquire per research topic. 
