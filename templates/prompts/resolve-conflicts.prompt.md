...
# Variables
`<branch-name>` = [branch-name](snippets/branch-name.md)
...
6. **Judge the resolution before publication**:
	1. Submit the resolved conflict set to the judge sub agent using [submit-to-judge](snippets/submit-to-judge.md).
